...
feedback_frame = tk.LabelFrame(frame, text='Dateityp')
feedback_frame.grid(row=0, column=0, padx=20, pady=10, sticky='n', rowspan=2)

radio_btn1 = tk.Radiobutton(feedback_frame, text='Word', variable=radio_var, value=1)
radio_btn1.grid(row=0, column=0, sticky='w', pady=5, padx=5)

radio_btn2 = tk.Radiobutton(feedback_frame, text='PowerPoint', variable=radio_var, value=2)
radio_btn2.grid(row=1, column=0, sticky='w', pady=5, padx=5)

radio_btn3 = tk.Radiobutton(feedback_frame, text='Excel', variable=radio_var, value=3)
radio_btn3.grid(row=2, column=0, sticky='w', pady=5, padx=5)

radio_btn4 = tk.Radiobutton(feedback_frame, text='Bild', variable=radio_var, value=4)
radio_btn4.grid(row=3, column=0, sticky='w', pady=5, padx=5)

sub_btn1 = tk.Button(feedback_frame, text='Bestätigen', command=choose)
...
sub_btn2 = tk.Button(sub_frame, text='Bestätigen', command=startconvert)
sub_btn2.grid(row=0, column=0, pady=21.5, padx=20)

feedback_lbl = tk.Label(text='Dateityp und Dateipfad wählen')
feedback_lbl.pack()
